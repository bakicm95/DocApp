	...
	<div class="columns">
		<div class="column">
			<form action="{{ route('permissions.store') }}" method="post">
				...
				<div class="block"> {{-- Permissions r-btns --}}
				...
				{{-- Permission Name (display_name) if type == basic --}}
				...
				{{-- Permission Slug (name) if type == basic --}}
				<div class="field" v-if="permissionType == 'basic'">
				...
				{{-- Permission Description if type == basic --}}
				<div class="field" v-if="permissionType == 'basic'">
				...
				{{-- Permission Resource if type == crud --}}
